...
export function generateMap(): MapNode[] {
  ...
  const nodes: MapNode[] = [
    ...
    { id: 'n3', type: 'elite_battle', enemyIds: ['mushroom_creature'], completed: false, x: 2, y: 0, connections: ['n7'] },

    // Row 2 (with campfire)
    { id: 'n4', type: 'normal_battle', enemyIds: undefined, completed: false, x: 0, y: 1, connections: ['campfire_1'] },
    { id: 'campfire_1', type: 'campfire', completed: false, x: 1, y: 1, connections: ['n5', 'n6'] },
    { id: 'n6', type: 'elite_battle', enemyIds: ['mushroom_creature'], completed: false, x: 2, y: 1, connections: ['n7'] },

    // Row 3
    { id: 'n5', type: 'normal_battle', enemyIds: undefined, completed: false, x: 0, y: 2, connections: ['n8'] },
